        ...
        <div class="wrap">
            ...
            <div class="container">
                <div class="float-left">
                    <a class="dn_btn" href="mailto:FamilyClinic@gmail.com">&emsp;&emsp;&emsp;&emsp;<span class="fa fa-envelope"></span></>FamilyClinic@gmail.com</a>
      ...
      <div class="banner_inner d-flex align-items-center" >
        <div class="container" >
          ...
          <div class="mb-3 mb-md-0">
              <h2>Sign  Up</h2>
              <p>Sign Up and login to Book the appointment to doctor</p>
          </div>
...
<br>
  ...
  <div class="card-body">
	...
	<div class="row">
				...
				<a href="index.php"><h3>Register as Patient</h3></a>
				</div>
				<!-- start: REGISTER BOX -->
